...
public class YPMagnifyingView: UIView {
    ...
    public override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        if let touch: UITouch = touches.first {
            ...
            self.touchTimer = Timer.scheduledTimer(timeInterval: magnifyingGlassShowDelay,
                                                   target: self,
            ...
            print(self.getPixelColorAtPoint(point: touch.location(in: self), sourceView: self))
    ...
    func createColorLabel(x: CGFloat, y: CGFloat, color: String) {
        ...
        colorLabel.frame = CGRect(x: x,
                                  ...
                                  height: self.bounds.size.width/4)
